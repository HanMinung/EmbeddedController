...
//1. GPIO Pin for TX and RX	
	...
	indiv_init(GPIO_TX, pinTX, AF, PUSH_PULL, NO_PUPD, HIGH_SPEED);
	indiv_init(GPIO_RX, pinRX, AF, PUSH_PULL, NO_PUPD, HIGH_SPEED);
...
//	GPIO_init(GPIO_RX, pinRX, AF);											// GPIO mode setting : AF
  ...
  GPIO_pupd(GPIO_TX, pinTX, NO_PUPD);
